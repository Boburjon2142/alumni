...
urlpatterns = [
    ...
    path("alumni/<slug:slug>/confirm", AlumniConfirmView.as_view()),
    path("alumni/<slug:slug>/", AlumniDetailView.as_view(), name="alumni-detail"),
    path("alumni/<slug:slug>", AlumniDetailView.as_view()),
    path("featured-alumni/", FeaturedListView.as_view(), name="featured-alumni"),
    path("featured-alumni", FeaturedListView.as_view()),
