...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        alumnus, _ = AlumniProfile.objects.get_or_create(
            slug="qardu-bitiruvchisi",
            defaults={
                "full_name": "QarDU bitiruvchisi",
                "graduation_year": 2020,
                "degree": "Bakalavr",
                "position": "Yosh mutaxassis",
                "country": "O‘zbekiston",
                "bio": "QarDUda olgan bilimlarini kasbiy rivoj va jamiyat manfaatiga yo‘naltirayotgan bitiruvchi.",
                "is_published": True,
                "is_featured": True,
            },
        )
        ...
        story, created = SuccessStory.objects.get_or_create(
            slug="qardudan-professional-rivoj-sari",
            defaults={
                "alumnus": alumnus,
                "title_uz": "QarDUdan professional rivoj sari",
        ...
        sections = (
            ("university", "Universitetdagi poydevor", "QarDUdagi ta’lim jarayoni nazariy bilim bilan birga mustaqil fikrlash, mas’uliyat va jamoada ishlash ko‘nikmalarini shakllantirdi."),
