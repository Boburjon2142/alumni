...
const preview={...summary,verified:true,position:"Engineer",current_company:"QarDU Tech",faculty:"IT",graduation_year:2018,skills:[],is_featured:true,timeline:[{id:1,year:2018,title:"Bitirgan",type:"education",order:0}],achievements:[],sources:[]} as AlumniPreview;
...
describe("AlumniCardGrid",()=>{
  ...
  it("renders a minimal card and opens an accessible quick profile",async()=>{
    ...
    expect(await screen.findByText("Engineer — QarDU Tech")).toBeInTheDocument();
